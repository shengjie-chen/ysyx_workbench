...
#define INSTPAT_MATCH(s, name, type, ... /* body */)             \
  ...
  // INSTPAT("010000 ?????? ????? 101 ????? 00100 11", srai   , I, R(dest) = ((int64_t)src1 >> BITS(src2,5,0)));   // RV64I
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw, R, R(dest) = SEXT(((int32_t)SEXT(src1, 32) / (int32_t)SEXT(src2, 32)), 32));
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw, R, R(dest) = SEXT((BITS((src1), 31, 0) / BITS((src2), 31, 0)), 32));
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw, R, R(dest) = SEXT(((int32_t)SEXT(src1, 32) % (int32_t)SEXT(src2, 32)), 32));
