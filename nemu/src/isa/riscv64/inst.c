...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  // INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divuw  , R, R(dest) = SEXT(((signed)SEXT(src1,32) / (signed)SEXT(src2,32)),32));
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = SEXT(((signed)SEXT(src1,32) % (signed)SEXT(src2,32)),32));
  // INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remuw   , R, R(dest) = SEXT(((signed)SEXT(src1,32) % (signed)SEXT(src2,32)),32));
