...
class RVNoob extends Module with ext_function {
  ...
  val hazard : HazardDetect = HazardDetect(idu.io.id_rf_ctrl,idu.io.id_csr_ctrl,ex_reg.out.wb_rf_ctrl,ex_reg.out.wb_csr_ctrl,mem_reg.out.wb_rf_ctrl,mem_reg.out.wb_csr_ctrl,dnpc_en)
